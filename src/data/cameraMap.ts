...
export const hotspots: CameraHotspot[] = [
  ...
  },
  {
    ...
    sonyName: 'C1',
    whatItDoes: 'A button you choose the job for. It sits right by your shooting finger.',
    beginnerTip: 'Assign Focus Area to C1 so you can switch between Wide and Spot focus instantly.',
    recommendCustom: true,
  },
  {
    id: 'shutter',
  ...
  },
  {
    ...
    label: 'AEL button',
    sonyName: 'AEL',
    whatItDoes: 'Locks the brightness so it does not change when you recompose. Reassignable.',
    beginnerTip: 'Assign Eye AF here so one thumb press snaps focus to the nearest eye.',
    recommendCustom: true,
  },
  {
    id: 'fn',
