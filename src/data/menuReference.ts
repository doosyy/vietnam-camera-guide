...
export const menuItems: MenuRefItem[] = [
  ...
  { id: 'subj-recog', tab: 'focus', group: 'Subject recognition', name: 'Recognise subjects', sony: 'Subject Recognition in AF', plain: 'The camera finds and locks onto your subject automatically. Leave on.' },
  ...
  { id: 'format', tab: 'shooting', group: 'Media', name: 'Format card', sony: 'Format', plain: 'Wipes a card clean. Do it once on a fresh card before shooting.' },
  ...
  { id: 'audio-signal', tab: 'setup', group: 'Sound & screen', name: 'Beeps', sony: 'Audio signals', plain: 'The focus/shutter beep. Turn off for discreet shooting.' },
  ...
  { id: 'memory-recall', tab: 'shooting', group: 'Shooting Mode', name: 'Save a setup', sony: 'Camera Set. Memory', plain: 'Store a whole configuration to a number on the mode dial.' },
