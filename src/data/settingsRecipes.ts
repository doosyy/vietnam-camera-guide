...
export const settingRecipes: SettingRecipe[] = [
  ...
  },
  {
    ...
    fast: ['Press the right edge of the control wheel (it opens ISO on a fresh camera). Or press Fn and highlight the ISO tile.'],
    steps: [
      'Press the MENU button (top-left on the back).',
      'At the top of the screen, move across to the Exposure/Color tab.',
      'Move down to the Exposure group and highlight ISO.',
  ...
  },
  {
    ...
    steps: [
      ...
      'Move down to the Exposure group and highlight ISO Range Limit.',
  ...
  },
  {
    ...
    steps: [
      'Press the MENU button.',
      'Move across to the Exposure/Color tab.',
      'Move down to the Exposure group and highlight ISO AUTO Min. SS.',
      'Press the centre of the wheel to open it.',
  ...
  },
  {
    ...
    fast: ['Best: assign it to the rear dial (see "Assign your custom buttons"), then just spin. Or press Fn and highlight the Exposure Comp. tile.'],
    steps: [
      'Press the MENU button.',
      'Move across to the Exposure/Color tab.',
  ...
  },
  {
    ...
    steps: [
      ...
      'For a one-press version, assign "Tracking On" to the centre button of the control wheel (see Custom buttons).',
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      'Still in the Focus tab, move down to Peaking Display and press the centre.',
      'Highlight Peaking Display, press the centre, turn to On, press the centre.',
  ...
  // ════════════ DRIVE, TIMER & FILES ════════════
  {
    ...
    fast: ['Press the left edge of the control wheel (it opens Drive Mode on a fresh camera), turn to a mode, press the centre.'],
    steps: [
      'Press the left edge of the control wheel to open Drive Mode. (Or press MENU, move to the Shooting tab, highlight Drive Mode, press the centre.)',
  ...
  },
  {
    ...
    steps: [
      'Press the left edge of the control wheel to open Drive Mode (or MENU › Shooting › Drive Mode).',
  ...
  },
  {
    ...
    pick: 'Keep it Off normally and flick it On in quiet places. Put it on the Fn grid or the C2 button so it is one tap away.',
