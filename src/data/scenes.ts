...
export const scenes: Scene[] = [
  // ---------- STREET ----------
  {
    ...
    howTo: [
      ...
      'Leave ISO on Auto. The limits you set at home handle the rest.',
    ],
    watchFor: [
  ...
  },
  {
    ...
    settings: {
      default: {
        ...
        iso: 'Auto',
        focusMode: 'AF-C (continuous)',
        focusArea: 'Spot (or tap the person)',
        drive: 'Single',
        whiteBalance: 'Auto',
      },
    },
    why: 'A low f-number blurs the busy background and makes the person pop. Eye autofocus nails the eyes for you. A Spot area, or a tap on the person, tells the camera exactly who matters.',
    howTo: [
      'Mode dial to A, open the aperture as low as it goes.',
      'Press C1 to flip the focus area to Spot, or simply tap the person on the screen.',
      'Half-press and let the eye box lock (or press C2 for Eye AF), then shoot.',
    ],
    watchFor: [
  ...
  // ---------- NIGHT ----------
  {
    ...
    howTo: [
      ...
      'Leave ISO on Auto. The 12800 ceiling you set at home covers the dark.',
  ...
  // ---------- MORE STREET ----------
  {
    ...
    settings: {
      default: {
        ...
        iso: 'Auto',
        focusMode: 'AF-C (continuous)',
        focusArea: 'Wide + hold AF-ON to track',
        drive: 'Continuous Lo',
        whiteBalance: 'Auto',
      },
    },
    ...
    howTo: [
      ...
      'Hold AF-ON to lock onto a rider, swing smoothly with them, fire a short burst as they pass, and keep swinging through the shot.',
    ],
    watchFor: [
