...
export const setupSteps: SetupStep[] = [
  ...
  { id: 'def-extras', group: 'defaults', title: 'Set-and-forget quality helpers', why: 'A few options to switch on once that quietly improve every photo.', steps: ['Lens Compensation: set Shading, Chromatic Aberration and Distortion to Auto.', 'Anti-flicker Shooting: On, to kill stripes under market and shop lights.', 'High ISO NR: Normal, for cleaner night shots.', 'Then forget them, they work in the background.'] },
