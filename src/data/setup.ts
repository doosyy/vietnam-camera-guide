...
export const setupSteps: SetupStep[] = [
  ...
  { id: 'def-focus', group: 'defaults', title: 'Focus defaults', why: 'Sensible street defaults so you are ready the moment you lift the camera.', steps: ['Focus Mode: AF-C (MENU → Focus → Focus Mode).', 'Focus Area: Wide (MENU → Focus → Focus Area).', 'MENU → Focus → Subject Recognition: Subject Recognition in AF On, Target Human (switch to Animal for street dogs and temple cats).'] },
